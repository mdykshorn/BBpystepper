#!/usr/bin/python
""" 
bbpystepper is a ROS node that rotates a LIDAR lite sensor 360 degrees using a stepper
motor and publishes distance data in the LaserScan.msgs to the topic of /scan
modified by Morgan Dykshorn <mdd27@vt.edu>
"""
import time
import math
import rospy
